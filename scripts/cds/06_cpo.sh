...
styles=("aae" "bible" "coha_1810" "coha_1890" "coha_1990" "joyce" "lyrics" "poetry" "shakespeare" "switchboard" "tweets")
base_model_name="meta-llama/Llama-2-7b-hf"
po_sample_strategy="fear"
po_algo="cpo"
n_epochs="16"
po_algo_param="default"
po_adapter_root="trained_models/cds/transfer/cpo/${po_algo_param}"
sft_adapter_path="trained_models/cds/transfer/sft/checkpoint-best"
dataset_dir="data/cds/sampled"
output_root="outputs/cds/transfer/cpo"
validation_output_root="outputs/cds/transfer/cpo_validation"
...
do
    ...
    po_data_root="data/cds/cpo/${po_algo_param}/round_${iter_i}/${po_sample_strategy}"
